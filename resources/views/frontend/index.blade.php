...
<div class="content">
	...
	<h5>
		...
		<span class="glyphicon glyphicon-time"></span> Terbit {{ date("d-m-Y",strtotime($post->created_at)) }}&nbsp;&nbsp;
		<span class="glyphicon glyphicon-time"></span> Revisi {{ date("d-m-Y",strtotime($post->updated_at)) }}
